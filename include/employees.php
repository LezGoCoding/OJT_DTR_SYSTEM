<?php
	...
	*/
	...
	class Employees{
		...
		function find_all_employees($name=""){
			global $mydb;
		...
		// CHECKING OF EMPLOYEE QR CODE IF EXISTIING IN THE DATABASE 
		function find_by_qr_code($qr_code) {
		    global $mydb;
		    $sql = "SELECT emp_id, CONCAT(first_name, ' ', last_name) AS fullname, department, position, profile_pic 
		            FROM " . self::$tbl_name . " 
